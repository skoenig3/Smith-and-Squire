...
xlfile = '15sec_SS1only_matlab_input_data.xlsx';
...
save('SmithSquireData_36_processed','subjectdata') %save data since takes so long to run
...
tic
load('SmithSquireData_36_processed.mat');
...
save('KLDivergenceData_36_processed','overlap','Chanceoverlap','trialdifference','imagepairs')
...
filename = 'Subject1_and_KL_Data_15sec_processed.xls';
load('SmithSquireData_36_processed.mat')
load('KLDivergenceData_36_processed.mat')
